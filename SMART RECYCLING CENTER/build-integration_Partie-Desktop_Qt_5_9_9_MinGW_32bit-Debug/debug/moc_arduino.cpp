...
#include "../../integration_Partie/arduino.h"
...
QT_MOC_LITERAL(1, 8, 19), // "arduinoDataReceived"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 4), // "data"
QT_MOC_LITERAL(4, 34, 15), // "processRFIDData"
QT_MOC_LITERAL(5, 50, 17) // "read_from_arduino"

    },
    "Arduino\0arduinoDataReceived\0\0data\0"
    "processRFIDData\0read_from_arduino"
};
...
void Arduino::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->arduinoDataReceived((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 1: _t->processRFIDData(); break;
        case 2: _t->read_from_arduino(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Arduino::*_t)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Arduino::arduinoDataReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Arduino::arduinoDataReceived(const QByteArray & _t1)
{
